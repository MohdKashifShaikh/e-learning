...
const Register = () => {
  document.title = "Teacher Sign Up";
  ...
  const handleFormSubmit = async (e) => {
    ...
    axios({
      ...
      url: `${SERVER_URL}/api/teacher/register`,
      headers: {
  ...
  return (
    <body className="templatemo-bg-gray">
      <h1 className="margin-bottom-15">Teacher Sign Up</h1>
        ...
        <div className="row">
          ...
          >
            <div className="form-inner">
              ...
              <div className="row form-group">
                ...
                <div className="col-lg-6">
                  <Link
                    to="/login"
                    className="btn btn-outline-danger btn-lg d-grid"
                  >
                    Already Signed Up ?
                  </Link>
                </div>
            ...
            <div className="text-center">
              <Link to="/register" class="templatemo-create-new">
                Sign Up as User
              </Link>
            </div>
          </form>
